function barplot_different_freqbandsNoNormalization(condition)
     close all
...
%         end
    ...
    for kk=size(D1_LFP_1_all,1):-1:1
        ...
        for condz=1:numel(D1_LFP_temp.conditions)
            ...
            saveas(gcf, ['D:\home\results Percept Project\Summary\', 'barplot_EEG_', condition, '_',D1_LFP_temp.conditions{condz}, '_NoNormalization.png'])
...
%             D2_LFP_1=D2_LFP_1(4:7,:);
            ...
            spm_mkdir(['D:\home\results Percept Project\Summary']);
            saveas(gcf, ['D:\home\results Percept Project\Summary\', 'barplot_Left_', condition,  '_', D1_LFP_temp.conditions{condz}, '_NoNormalization.png'])
            ...
            spm_mkdir(['D:\home\results Percept Project\Summary']);
            saveas(gcf, ['D:\home\results Percept Project\Summary\', 'barplot_Right_', condition,  '_',D1_LFP_temp.conditions{condz}, '_NoNormalization.png'])
            ...
            spm_mkdir(['D:\home\results Percept Project\Summary']);
            saveas(gcf, ['D:\home\results Percept Project\Summary\', 'barplot_LFPcombined_', condition,  '_',D1_LFP_temp.conditions{condz}, '_NoNormalization.png'])
