function plotLogSpectra_baselinedAverage(condition)
    ...
    for i=1:numel(initials)
        ...
        EEGchannels=[D2_EEG_temp.indchannel('C3') D2_EEG_temp.indchannel('C4'), D1_EEG_temp.indchannel('Cz')];
    ...
    for kk=size(D1_LFP_1_all,1):-1:1
        ...
        for limb=1:2
            ...
            h2=plot(D1_EEG_temp.frequencies, mean(D1_EEG), 'r', 'LineWidth', 8)
...
%             legend([h1, h2],{'on', 'off'})
            ...
            fill(x2, inBetween, 'g', 'FaceAlpha', 0.2, 'LineStyle','none'); % , 'FaceAlpha', 1
            hold on, h1=plot(freqs, meanD_diff, 'g', 'LineWidth', 3);
...
%             hold on, plot(D1_EEG_temp.frequencies, D1_LFP_1, 'r--', 'LineWidth', 2)
            hold on,
            h1=plot(D1_EEG_temp.frequencies, mean(D2_LFP_1), 'b', 'LineWidth', 8)
            h2=plot(D1_EEG_temp.frequencies, mean(D1_LFP_1), 'r--', 'LineWidth', 8)
...
%             hold on, plot(D1_EEG_temp.frequencies, D1_LFP_2, 'r--', 'LineWidth', 2)
            hold on, 
            h1=plot(D1_EEG_temp.frequencies, mean(D2_LFP_2), 'b', 'LineWidth', 8)
            h2=plot(D1_EEG_temp.frequencies, mean(D1_LFP_2), 'r--', 'LineWidth', 8)
...
%             hold on, plot(D1_EEG_temp.frequencies, D1_total_LFP, 'r--', 'LineWidth', 2)
            hold on,
            h1=plot(D1_EEG_temp.frequencies, mean(D2_total_LFP), 'b', 'LineWidth', 8)
            h2=plot(D1_EEG_temp.frequencies, mean(D1_total_LFP), 'r--', 'LineWidth', 8)
...
%             title(['Both GPis ', condition, ' ', D1_EEG_temp.conditions{condz}],  'FontSize', 50)
            ...
            size_font=100;
            y1 = ylim;
            hold on, xline(find(D1_EEG_temp.frequencies==4), 'm--', 'LineWidth', 3)
            if h_theta==1 
%                 plot(5, 0.05, 'k*', 'MarkerSize', sizestar) 
            ...
            xline(find(D1_EEG_temp.frequencies==8), 'm--', 'LineWidth', 3)
            if h_alpha==1 
%                 plot(9, 0.05, 'k*', 'MarkerSize', sizestar), 
            ...
            xline(find(D1_EEG_temp.frequencies==12), 'm--', 'LineWidth', 3)
            if h_beta==1 
%                 plot(20.5, 0.05, 'k*', 'MarkerSize', sizestar), 
            ...
            xline(find(D1_EEG_temp.frequencies==31), 'm--', 'LineWidth', 3)
            if h_lowgamma==1 
%                 plot(40, 0.05, 'k*', 'MarkerSize', sizestar), 
            ...
            xline(find(D1_EEG_temp.frequencies==50), 'm--', 'LineWidth', 3)
            if h_highgamma==1 
