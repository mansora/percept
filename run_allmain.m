...
for t=1   %1:numel(tasks)
    failed_patient_Off={};
    failed_patient_On={};
    for i=1:3 %numel(initials)
        close all
...
% end
% 
% % dbs_percept_Coherence_topoplotAveraged('R', 'Coherence', [4 7])
% % dbs_percept_Coherence_topoplotAveraged('R', 'Coherence', [8 12])
% % dbs_percept_Coherence_topoplotAveraged('R', 'Coherence', [13 30])
% % dbs_percept_Coherence_topoplotAveraged('R', 'Coherence', [31 48])
% % dbs_percept_Coherence_topoplotAveraged('R', 'Coherence', [52 80])
...
% 
% plotConnectivityAverageValidation(condition, Coh_state)
